...
describe("Load PGN", function () {
    ...
    var tests = [
        ...
        {fen: '3n2k1/5p1p/5P1P/8/8/8/8/QRR4K w - - 0 1',
            pgn: [
                '1. Rb8 ( 1. Qa8 Kh8 ( 1... Kf8 2. Qxd8# ) 2. Qxd8# ) ( 1. Rc8 Kh8 ( 1... Kf8 2. Rxd8# ) 2. Rxd8# )',
                '1... Kh8 ( 1... Kf8 2. Rxd8# ) 2. Rxd8# 1-0']},
...
describe("History", function () {
    ...
    tests.forEach(function (t, i) {
        ...
        it(i, function () {
            ...
            var history = chess.moves({verbose: t.verbose});
            if (t.fen != chess.fen()) {
                passed = false;
...
describe('Regression Tests', function () {
    ...
    it('Issue #32 - castling flag reappearing', function () {
